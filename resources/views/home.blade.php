...
<div class="container">
    <div class="row justify-content-center">
        ...
        <!--New member fees dashbord-->
        <div class="col-9" style="border-radius: 6px; border:1px solid #444;box-shadow:1px 1px 5px #000;">
            <div class="card mt-2">
                @if($ndata)
                <div class="card-header">{{ __('New members which have not submitted fees yet!') }}</div>
                    ...
                    <table class="table table-striped table-dark table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{$info->name}}</td>
                                <td>{{$info->mobile}}</td>
                                <td> <a href="/payment/{{ $info['id'] }}" class="btn btn-warning btn-lg btn-block btn-sm px-3 rounded-pill text-black font-semibold">Fees</a>
                                </td>
            ...
            @endif
        <!--plan expire in 3days-->
            <div class="card mt-2">
                <div class="card-header ">{{ __('Plan wil expire in 3days') }}</div>
                    ...
                    <table class="table table-striped table-dark table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{date('d-M-Y',strtotime($info->planexpiredate))}}</td>
                                <td> <a href="/payment/{{ $info['member_id'] }}" class="btn btn-warning btn-lg btn-block btn-sm px-3 rounded-pill text-black font-semibold">Fees</a>
                                </td>
                                <td>
                                    <div class="container">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade " id="myModal_{{$info['member']->id }}" role="dialog">
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                {{ date('d-M-Y',
                                                                                strtotime($payinfo['dos'])) }}
                                                                            </td>

                                                                            <td>
                                                                                {{ date('d-M-Y',
                                                                                strtotime($payinfo['planexpiredate']))
                                                                                }}
                                                                            </td>
                                                                            <td>
                                                                                {{ $payinfo['plan_name'] }}
                                                                            ...
                                                                            <td>{{ $payinfo['plan_discount'] ?
                                                                                $payinfo['plan_discount'] . '%' : '-' }}
                                                                            </td>
                                                                            <td>{{ $payinfo['plan_fees'] -
                                                                                ($payinfo['plan_fees'] *
                                                                                $payinfo['plan_discount']) / 100 }}
                                                                            </td>
                                                                            <td>{{ $payinfo['extradiscount'] ?
                                                                                $payinfo['extradiscount'] . '%' : '-' }}
