        ...
        <div class="col-9" style="border-radius: 6px; border:1px solid #444;box-shadow:1px 1px 5px #000;">
            <div class="card bg-transparent">
                <div class="card-header text-center">
                    <span style="color:#f36100">Create Member</span>
                </div>
            </div>
                ...
                <form method="POST" action="/members/">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="gender" id="gender" class="form-select text-white bg-transparent"
                            ...
                            <option value="female" class="text-black" {{old('gender')=='female' ? "selected" : "" }}>
                                Female</option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="Text" name="height" id="height" value="{{old('height')}}" class="form-control"
                            placeholder="Enter Height" pattern="[0-9]{1}\.{0-9}\d{1,2}">
                    </div>
                    <div class="mb-3">
                        <label for="weight">Weight :</label>
                        <input type="weight" name="weight" value="{{old('weight')}}" id="weight" class="form-control"
